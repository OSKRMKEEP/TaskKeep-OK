...
async function startBot() {
  ...
  cron.schedule('0 9 * * *', async () => {
    ...
    try {
      ...
      if (snap.empty) {
        console.log('Sin tareas pendientes hoy.');
        return;
      }

      let report = '*📋 Buen día, este es el reporte de tareas pendientes:*\n\n';
      snap.forEach(d => {
        const t = d.data();
      ...
      console.log('✅ Cron enviado exitosamente.');
    } catch (e) {
